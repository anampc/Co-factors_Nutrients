...
```{r}
Temperature<- ggplot(Temp, aes (Day, Temperature, colour=Group)) +
  #geom_jitter(aes(colour=Group), alpha=1, size=0.5)+
  stat_summary(fun.data = "mean_cl_boot", 
  ...
  scale_y_continuous(limits = c(27.3, 31.3),
      ...
      scale_x_continuous(breaks = seq(0, 45, 7),
                      name=("Day in the expeiment")) +
...
NH4_2<- ggplot(Corals, aes(Week, NH4, fill=Treatment, colour=Treatment)) +
  ...
  MyTheme
  #NH4_Temp+facet_wrap(~Nutrients)
  NH4_2+facet_grid(Disease~Nutrients)
```
